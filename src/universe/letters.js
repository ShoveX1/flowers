...
export function createCosmicLetters(scene) {
  ...
  const defaultLetters = [
    {
      id: 'letter-1',
      recipient: 'Para la Futura Psicóloga 🧠',
      title: 'Ánimo con la Carrera 🌻',
      date: '21 de Septiembre',
      body: 'Sé que la carrera exige un montón de lecturas y desvelos, pero le estás echando muchas ganas. ¡Vas a ser una psicóloga genial, no te rindas!',
      author: 'Tu amigo',
      radius: 18,
      angle: 1.1,
      y: 7,
    ...
    {
      id: 'letter-2',
      recipient: 'Para Mi Amiga',
      title: 'Pausa Anti-Estrés 💛',
      date: 'Flores Amarillas',
      body: 'Unas flores amarillas para recordarte que entre parciales y tareas también toca descansar. ¡Aquí tienes a un amigo para cuando necesites despejarte!',
      author: 'Un abrazo fraternal',
      radius: 30,
      angle: 2.6,
      y: -8,
      scale: 1.1
    },
    {
      id: 'letter-3',
      recipient: 'Para Ti 🧠',
      title: 'Dosis de Serotonina ⚡',
      date: 'Semana de Parciales',
      body: 'Que estas flores te suban el ánimo y la dopamina. Confía en lo que has estudiado, tú puedes con cada examen y con todo el semestre.',
      author: 'Apoyándote siempre',
      radius: 42,
      angle: 4.1,
      y: 6,
      scale: 1.0
    ...
    {
      id: 'letter-4',
      recipient: 'Colega de Vida',
      title: 'Sigue Dándolo Todo 🌼',
      date: 'Hoy y Siempre',
      body: 'Elegiste una carrera muy bonita y necesaria. Cada esfuerzo que haces hoy va a valer totalmente la pena. ¡A darle con todo!',
      author: 'Tu amigo',
      radius: 54,
      angle: 5.3,
      y: -4,
